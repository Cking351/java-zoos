...
* [ ] A data.sql file has been provided with seed data. You can use this class directly or modify it to fit your com.lambda.javazoo.models. However, the data found in the file is the seed data to use!
